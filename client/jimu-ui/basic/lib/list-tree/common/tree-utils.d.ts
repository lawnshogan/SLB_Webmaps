import { TreeItemInRelationType, TreeItemType, TreeItemsType, TreeItemActionType, TreeSelctionStyle } from './tree-types';
/**
 ...
 * Get selection style
 */
export declare function getSelectionStyle(isTree: any, isMultiSelection: any, treeStyle: any, checkboxLinkage: any): TreeSelctionStyle;
