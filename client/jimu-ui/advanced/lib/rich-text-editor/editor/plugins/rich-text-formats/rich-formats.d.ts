...
import { Formats, FormatType, RichTextFormatKeys } from '../../../type';
export interface RichTextFormatsPanelPorps {
    /**
...
export declare const RichTextFormatsPanel: (props: RichTextFormatsPanelPorps) => React.ReactElement;
