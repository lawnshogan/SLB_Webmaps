...
import { EdiotrValue, Editor, DeltaValue, Sources, UnprivilegedEditor, RichSelection, Modules } from '../type';
...
export interface RichEditorCoreProps extends EditorOptions, EditorProps, Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> {
     ...
     * Note:
     *  - due to limitations in quilljs, this is actually a semi-controlled mode, meaning that the edit is not prevented, but changing value will still replace the contents.
