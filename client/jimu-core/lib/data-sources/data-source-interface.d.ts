 ...
 */
export declare type ArcGISSubLayer = __esri.Sublayer | __esri.KMLSublayer | __esri.WMSSublayer | __esri.WMTSSublayer | __esri.BuildingSublayer | __esri.BuildingGroupSublayer;
/**
...
export interface JSAPILayerMixin {
     ...
     *   1.1 a data source may have a layer, the layer is only used to communicate with Maps SDK for JavaScript (get popupTemplate, symbol and so on), if want to query features, should use data source instance.
     ...
     *   1.4 if widget needs an ArcGIS Maps SDK for JavaScript layer, call `data source.createJSAPILayerByDataSource()` to create a new layer, do not use layer in data source instance directly, to apply data source changes to the new layer, see 2.2.
     *
